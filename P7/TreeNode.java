...
// System.out.print(id + ") " + textOfNode);
        ...
        System.out.println(""); 
              ...
              System.out.print(" ,Scope=" + scope + " ,Type="+type);
//              if(value.equals("+")){
...
//              }
    ...
    public void renameDeF(int id, String name){
             if (id == this.id) {
    ...
    public void deleteCode(int id){
       ...
       public void specialPrint(int tab){
              
     if(textOfNode=="PROG"){
          System.out.print(id+")"+textOfNode  + " Type: "+type);
             System.out.println();
     }else if(textOfNode=="CODE"){
          System.out.print(id+")"+textOfNode + " Type: "+type);
             System.out.println();
     }else if(textOfNode=="PROC_DEFS"){
         System.out.print(id+")"+textOfNode + " Type: "+type);
            System.out.println();
     }
        ...
        while (l.hasNext()) {
            TreeNode t = l.next();
            if(t.textOfNode=="PROG" ||t.textOfNode=="CODE" ||t.textOfNode=="PROC_DEFS"  ){
            ...
            System.out.print("*-* ");
               ...
               t.specialPrint(tab + 1);
           

        }
    }
       
           public void printDeleteScope(int tab) {
...
// System.out.print(id + ") " + textOfNode);
        ...
        System.out.println(""); 
              ...
              System.out.print(" ,Scope=" + scope + " ,Type="+type + " Delete="+delete);
        System.out.println("");
        }
