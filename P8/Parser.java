...
//        }
    ...
    public GNode A() {
        ...
        if (b.status && o.status) {
            ...
            if( b.n.children.size()>1){
                TreeNode a = b.n.children.get(1);
                b.n.children.remove(a);
                t.addChild(b.n);
                t.addChild(a);
            }else{
                  t.addChild(b.n);
        ...
        if (it.hasNext() && it.next().tokenName == "proc") {
            ...
            if (it.hasNext()) {
                ...
                if (tok.tokenName == "variable") {
                    variable = new TreeNode(index, table, true, "UserDefinedNameDef");
                    index++;
...
//System.out.println("Parser.D()"+tok);
    ...
    public GNode G() {
        ...
        if (it.hasNext()) {
            ...
            if (tok.tokenName == "variable") {
                TreeNode v = new TreeNode(id, table, false, "UserDefinedNameCall");
            ...
            if (tok.tokenName == "variable") {
                ...
                if (it.hasNext()) {
                    if (it.next().tokenName == "assignmentOperator") {
                        ...
                        // index++;
                        TreeNode v = new TreeNode(index, table, true, "UserDefinedNameCall");
                        v.contents = tok.token;
                        index++;
                        // TreeNode var = new TreeNode(index, table, true, tok.token);
                        //index++;
                    ...
                    TreeNode call = new TreeNode(id, table, false, "CALL");
                    //index++;
                    TreeNode v = new TreeNode(index, table, false, "UserDefinedNameCall");
                    index++;
                    TreeNode var = new TreeNode(index, table, true, tok.token);
                    var.contents = tok.token;
                    GNode g = new GNode(true);
...
//        }
    ...
    public GNode forLoop() {
        ...
        GNode k = K();
        if (k.status) {
            k.n.children.get(0).textOfNode="variableFor";
            ...
            if (it.hasNext() && it.next().tokenName == "assignmentOperator") {
                ...
                if (it.hasNext() && it.next().token.equals("0")) {
                    ...
                    if (it.hasNext() && it.next().tokenName == "semicolon") {
                        GNode k2 = K();
                         k2.n.children.get(0).textOfNode="variable";
                        ...
                        if (k2.status) {
                            if (it.hasNext() && it.next().tokenName == "compLess") {
                                ...
                                GNode k3 = K();
                                if (k3.status) {
                                     k3.n.children.get(0).textOfNode="variable";
                                    retTree.addChild(k3.n);
                                    if (it.hasNext() && it.next().tokenName == "semicolon") {
                                        GNode k4 = K();
                                        if (k4.status) {
                                             k4.n.children.get(0).textOfNode="variable";
                                            ...
                                            if (it.hasNext() && it.next().tokenName == "assignmentOperator") {
                                                ...
                                                if (it.hasNext() && it.next().tokenName == "add") {
                                                    ...
                                                    if (it.hasNext() && it.next().tokenName == "openBracket") {
                                                        GNode k5 = K();
                                                        if (k5.status) {
                                                             k5.n.children.get(0).textOfNode="variable";
