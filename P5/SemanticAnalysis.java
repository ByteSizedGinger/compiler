...
public class SemanticAnalysis {
        ...
        while (it.hasNext()) {
            ...
            if (t.textOfNode.equals("UserDefinedNameDef") && t.vName == null) {
                ...
                if (found == true) {
                    ...
                    // System.out.println("Semantic Error: procedure call with no matching definition "+t.contents);
                    // exit(0);
                }
    ...
    public boolean findMatchingProcCalls(String name, String scope, String newName) {
        ...
        while (it.hasNext()) {
            ...
            if (t.textOfNode.equals("UserDefinedNameCall") && t.contents.equals(name)) {
                //System.out.println(" Def:"+t.contents + "Call:"+name);
    ...
    public boolean testNextScope(TableNode t, String newName,String scope, String tScope){
        ...
        if(scope.startsWith(tScope.substring(0,tScope.length()-2))){
            t.vName=newName;
            return true;
        }else if(forLoopScopeList.contains(tScope)){
            return testNextScope(t, newName, scope, tScope.substring(0,tScope.length()-2));
        }else{
            return false;
        }
